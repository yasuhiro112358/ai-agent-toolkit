...
| [prompt-create-from-conversation](prompts/prompt-create-from-conversation/README.ja.md) | 完了した AI 作業から再利用可能なプロンプトを生成 | なし |
| [task-streamliner](prompts/task-streamliner/README.ja.md) | チャット AI（Claude.ai・ChatGPT 等）に貼り付けるだけで動くプロンプト駆動タスク管理システム。API キー・サーバー不要 | なし |

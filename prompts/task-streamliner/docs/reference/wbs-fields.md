...
| 制約 | 同一階層内で連番。アーカイブ後は詰め直す（再採番）。個別削除後は再利用しない |
...
| id | wbs | title | status | due | depends_on | tags | estimate |
|----|-----|-------|--------|-----|------------|------|----------|
| 1  | 1   | 発表資料を作る | In-Progress | 2026-05-20 | — | work | — |
| 2  | 1.1 | 構成案を作る | Done | 2026-05-14 | — | work | 1h |
| 3  | 1.2 | スライド作成 | In-Progress | 2026-05-16 | 2 | work | 3h |
| 4  | 1.3 | レビュー依頼 | Waiting | 2026-05-17 | 3 | work | 30m |
| 5  | 1.4 | 発表練習 | Todo | 2026-05-19 | 4 | work | 1h |
| 6  | 2   | 本番環境を構築する | Waiting | 2026-05-22 | 1 | infra | — |
| 7  | 2.1 | サーバー設定 | Todo | 2026-05-21 | — | infra | 2h |
| 8  | 2.2 | デプロイ確認 | Todo | 2026-05-22 | 7 | infra | 30m |
